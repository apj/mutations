...
{
	// TODO: Make sure that reports can handle multiple codes (ATM they
	// don't...)
	...
	ALL_METRIC_HISTORY(19), METRIC_HISTORY(20), // Report 20 from old version
	...
	// New report types
	OUTLYING_VERSIONS(333), FOCUS(444),

	// Vocabulary reports
	TERM_USAGE_HISTORY(201),
	VOCABULARY_GROWTH(201),
	TERM_FREQUENCY(202),
	TERM_GINI(203),
	TERM_FREQUENCY_VS_AGE(204),
	POPULAR_TERM(205),
	POPULAR_TERM_HISTORY(206),
	TERM_HISTORY_RANKED(208),
	VOCABULARY_MODIFICATION(209),
	TERM_OUTLIER(210),
	...
	public static EReportType fromCode(int reportCode)
	{
		for (EReportType type : EReportType.values())
			if (type.reportCode == reportCode) return type;
