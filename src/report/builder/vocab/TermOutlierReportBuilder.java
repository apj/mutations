...
public class TermOutlierReportBuilder extends ReportBuilder
{
...
//	private final double giniThreshold = 0.04;
	...
	public Report buildReport()
	{
		...
		Map<Integer, Map<String, Integer>> versionTokenCountMap = VocabularyReportUtil.getVocabularyUsageHistory(history);
		...
		for(Entry<Integer, Map<String, Integer>> versionTokenCountEntry : versionTokenCountMap.entrySet())
		{
			...
			double gini = VocabularyReportUtil.calculateTokenGini(tokenCountMap);
			int[] freqDist = VocabularyReportUtil.extractTokenFreqDist(tokenCountMap, 10);
